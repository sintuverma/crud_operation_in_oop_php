            ...
            <table class="table table-striped table-bordered">
               ...
               <tbody>
                  ...
                  <tr>
                     ...
                     <td align="center">
                        <a href="manage-users.php?id=<?php echo $value['userid'];?>" class="text-primary"><i class="fa fa-fw fa-edit"></i> Edit</a> | 
                        <a href="?type=delete&id=<?php echo $value['userid'];?>" class="text-danger"><i class="fa fa-fw fa-trash"></i> Delete</a>
                     </td>
                  </tr>
               <?php $sr++;} }else{ ?>
                  <tr>
