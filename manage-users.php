...
if(isset($_POST['submit']))
{
   ...
   if($id==''){
      ...
      //echo $id;
      //die();
      $result = $obj->updateData('users',$condition_arr,'userid',$id);
      
   }
   
   //header('location:users.php')//first type to redirect of the page
?>
   <script>
               ...
               <div class="col-sm-6">
                  ...
                  <form method="post">
                     ...
                     <div class="form-group">
                        ...
                        <input type="tel" class="tel form-control" name="mobile" id="mobile"  placeholder="Enter mobile" value="<?php echo $mobile ;?>"required>
                     </div>
                     <div class="form-group">
